...
const (
	UserService_Register_FullMethodName        = "/rin.user.v1.UserService/Register"
	UserService_Login_FullMethodName           = "/rin.user.v1.UserService/Login"
	UserService_Refresh_FullMethodName         = "/rin.user.v1.UserService/Refresh"
	UserService_GetProfile_FullMethodName      = "/rin.user.v1.UserService/GetProfile"
	UserService_CheckPermission_FullMethodName = "/rin.user.v1.UserService/CheckPermission"
)
...
type UserServiceClient interface {
	Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*AuthSession, error)
	Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*AuthSession, error)
	Refresh(ctx context.Context, in *RefreshRequest, opts ...grpc.CallOption) (*AuthSession, error)
...
func (c *userServiceClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*AuthSession, error) {
...
func (c *userServiceClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*AuthSession, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthSession)
...
func (c *userServiceClient) Refresh(ctx context.Context, in *RefreshRequest, opts ...grpc.CallOption) (*AuthSession, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthSession)
...
type UserServiceServer interface {
	Register(context.Context, *RegisterRequest) (*AuthSession, error)
	Login(context.Context, *LoginRequest) (*AuthSession, error)
	Refresh(context.Context, *RefreshRequest) (*AuthSession, error)
...
func (UnimplementedUserServiceServer) Register(context.Context, *RegisterRequest) (*AuthSession, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Register not implemented")
}
func (UnimplementedUserServiceServer) Login(context.Context, *LoginRequest) (*AuthSession, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Login not implemented")
}
func (UnimplementedUserServiceServer) Refresh(context.Context, *RefreshRequest) (*AuthSession, error) {
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "rin.user.v1.UserService",
	...
	Metadata: "rin/user/v1/user.proto",
}
